 ...
 * Use the {@link HinduFragment#newInstance} factory method to
...
public class HinduFragment extends Fragment {
    ...
    public static HinduFragment newInstance(String param1, String param2) {
        HinduFragment fragment = new HinduFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView webview = view.findViewById(R.id.webviewhindu);
